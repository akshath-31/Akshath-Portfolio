...
export default function Skills() {
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-sans selection:bg-white selection:text-black flex flex-col relative overflow-hidden">
      ...
      <main className="pt-32 pb-24 max-w-[100rem] mx-auto w-full z-10 grow relative px-6 md:px-12 lg:px-16 flex flex-col">
        
        {/* Top Header Section */}
        <div className="w-full mb-12 flex flex-col items-start gap-4">
          <h2 className="text-[11px] tracking-[0.3em] font-mono text-orange-500 uppercase font-medium">
            02 // Technical
          </h2>
